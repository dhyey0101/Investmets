...
export default class CopyContactToMCB extends Component {
    constructor(props) {
        super(props);
        this.state = {
            switch: false,
    ...
    async GenerateRandomNumber() {
        ...
        if (this.state.NumberHolder % 2 === 0) {
            ...
            await setTimeout(() => {
                this.props.navigation.navigate("CopyContactToMCB_2")
            }, 5000)
        }
    }
            ...
            return (
                <SafeAreaView style={styles.container}>
                    ...
                    <View style={{ paddingHorizontal: 10, marginTop: 20 }}>
                        <View>
                            <Text style={styles.notes}>This function will send a copy of all the contacts from the Accounts you have selected to your MCB Account</Text>
                        </View>
